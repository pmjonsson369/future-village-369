...
import verticalImg from "@/assets/smart-garden-vertical.jpg";
import aiImg from "@/assets/smart-garden-ai.jpg";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[85vh] flex items-end">
        <img
          src={heroImg}
          alt="Smart Garden System — automated hydroponic greenhouse"
          width={1920}
          height={1080}
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <img
              src={verticalImg}
              alt="Vertical farming with robotic automation"
              loading="lazy"
              width={1280}
              height={720}
            ...
            <p className="absolute bottom-6 left-6 text-sm font-body text-foreground/80">Automation — Robotic vertical farming</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <img
              src={aiImg}
              alt="AI monitoring systems for smart agriculture"
              loading="lazy"
              width={1280}
              height={720}
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent" />
            <p className="absolute bottom-6 left-6 text-sm font-body text-foreground/80">Intelligence — AI-powered monitoring</p>
          </motion.div>
        </div>
      </section>
