...
import villaEnergy from "@/assets/villa-energy.jpg";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[85vh] flex items-end">
        <img
          src={villaHero}
          alt="Scandinavian Self-Sustaining Villa in Nordic forest"
          width={1920}
          height={1080}
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 pb-20 w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold leading-tight tracking-tight mb-6 font-display">
              Scandinavian<br />Self-Sustaining Villa
            </h1>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <img
              src={villaInterior}
              alt="Villa interior with natural materials"
              loading="lazy"
              width={1280}
              height={720}
          ...
          >
            <img
              src={villaEnergy}
              alt="Solar panels and energy systems"
              loading="lazy"
              width={1280}
              height={720}
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent" />
            <p className="absolute bottom-6 left-6 text-sm font-body text-foreground/80">Energy — Solar & battery integration</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 text-center">
        ...
        >
          Interested in the villa system? Let's talk.
        </motion.p>
        <a
